...
return [
    ...
    'model_not_in_make' => 'Избраният модел не принадлежи на избраната марка.',
    'model_not_of_vehicle_type' => 'Избраният модел не е този вид превозно средство.',
    'photo_order_mismatch' => 'Новата подредба трябва да изброи всяка снимка на тази обява точно веднъж.',
    'radius_needs_origin' => 'Радиусът изисква координати или град, от който да се мери.',
    'coordinates_need_both' => 'Географската ширина и дължина трябва да се посочат заедно.',
