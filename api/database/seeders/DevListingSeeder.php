...
class DevListingSeeder extends Seeder
{
     ...
     */
    private const CARS = [
        ['make' => 'Volkswagen', 'model' => 'Passat', 'variant' => '2.0 TDI Highline', 'year' => 2016, 'km' => 168000, 'fuel' => FuelType::Diesel, 'gearbox' => Transmission::Manual, 'hp' => 150, 'price' => '8950.00', 'city' => 'Prishtinë', 'colour' => [38, 54, 78]],
        ...
        ['make' => 'Škoda', 'model' => 'Octavia', 'variant' => '1.6 TDI Ambition', 'year' => 2015, 'km' => 198000, 'fuel' => FuelType::Diesel, 'gearbox' => Transmission::Manual, 'hp' => 110, 'price' => '7300.00', 'city' => 'Beograd', 'colour' => [140, 146, 150]],
        ['make' => 'BMW', 'model' => 'Series 3', 'variant' => '320d Touring', 'year' => 2019, 'km' => 96000, 'fuel' => FuelType::Diesel, 'gearbox' => Transmission::Automatic, 'hp' => 190, 'price' => '14900.00', 'city' => 'Sofia', 'colour' => [26, 30, 36]],
        ['make' => 'Mercedes-Benz', 'model' => 'C-Class', 'variant' => 'C 220 d AMG Line', 'year' => 2017, 'km' => 143000, 'fuel' => FuelType::Diesel, 'gearbox' => Transmission::Automatic, 'hp' => 170, 'price' => '16500.00', 'city' => 'Tiranë', 'colour' => [198, 200, 204]],
        ['make' => 'Golf', 'model' => 'Golf', 'variant' => '1.6 TDI Comfortline', 'year' => 2014, 'km' => 212000, 'fuel' => FuelType::Diesel, 'gearbox' => Transmission::Manual, 'hp' => 105, 'price' => '6200.00', 'city' => 'Prizren', 'colour' => [156, 42, 44]],
        ['make' => 'Opel', 'model' => 'Astra', 'variant' => '1.6 CDTI Innovation', 'year' => 2017, 'km' => 134000, 'fuel' => FuelType::Diesel, 'gearbox' => Transmission::Manual, 'hp' => 136, 'price' => '8100.00', 'city' => 'Durrës', 'colour' => [60, 90, 120]],
